package hijack.dockerservice.cli;
...
public class RenderCommand extends ConfiguredCommand<DockerServiceMainConfiguration> {
    ...
    @Override
    protected void run(Bootstrap<DockerServiceMainConfiguration> bootstrap,
                       Namespace namespace,
                       DockerServiceMainConfiguration configuration) throws Exception {
